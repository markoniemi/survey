...
<body>
    ...
    <form:form class="form-horizontal" action="poll/save" modelAttribute="poll" method="post">
        ...
        <fieldset>
            <c:forEach items="${poll.questions}" var="question" varStatus="status">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <form:input id="questionText" path="questions[${status.index}].text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <form:select id="questionType" path="questions[${status.index}].type"
                            class="form-control input-md">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button id="addQuestion" name="" formaction="poll/addQuestion" class="btn btn-primary">
